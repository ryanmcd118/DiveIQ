...
export const createUserCertificationSchema = z.object({
  certificationDefinitionId: z
    .string()
    .min(1, "Certification definition ID is required"),
...
export type UpdateUserCertificationInput = z.infer<
  typeof updateUserCertificationSchema
>;
